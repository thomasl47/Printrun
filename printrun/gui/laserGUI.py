...
class laserGUI(wx.Panel):
    def __init__(self, parent, root):
        ...
        FocalGBSizer.Add(self.FDText1, wx.GBPosition(Y_BASELINE, BUTTONGPX2), wx.GBSpan(40, 50),
                         wx.ALIGN_CENTER_HORIZONTAL, 0)
        ...
        SetupGBSizer.Add(self.SpeedText2, wx.GBPosition(Y_BASELINE+24, BUTTONGPX2+105), wx.GBSpan(15, 40), 0, 0)
        ...
        SetupGBSizer.Add(self.SpeedText4, wx.GBPosition(Y_BASELINE+24, BUTTONGPX2+265), wx.GBSpan(15, 40), 0, 0)
        ...
        SetupGBSizer.Add( root.Thickness, wx.GBPosition(Y_BASELINE+40, BUTTONGPX2+165), wx.GBSpan(20, 110), 0, 0)
        ...
        ImpotyGBSizer.Add(root.FilePathLabel, wx.GBPosition(Y_BASELINE+15, BUTTONGPX2), wx.GBSpan(25, 280), 0, 0)
        ...
        ImpotyGBSizer.Add(self.ImportBtn, wx.GBPosition(Y_BASELINE+15, BUTTONGPX2+280+5), wx.GBSpan(25, 60), 0, 0)
